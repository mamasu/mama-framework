...
class FrontController {
    ...
    public function __construct(\Mmf\Autoloader\AutoloaderInterface $autoload, \Mmf\Parameter\ParametersInterface $config, \Mmf\IO\CommunicationInterface $communication) {
     ...
     */
    public function createCoreAndController($class, \Mmf\Event\EventManagerInterface $eventManager, \Mmf\IO\RequestInterface $request, \Mmf\IO\ResponseInterface $response, BasicViewInterface $view, \Mmf\Language\LanguageInterface $language, \Mmf\Routing\RoutingResolverAbstract $router, ErrorControllerInterface $error, \Mmf\Parameter\SessionInterface $session, ConnectionInterface $connection, \Mmf\Auth\AuthInterface $auth
    ) {
        ...
        if (class_exists($class) && class_exists($coreClass)) {
            ...
            throw new CoreException('Is not unable to create the controller'
     ...
     * @throws \CoreException
     */
    public function callClassAndMethodWithInputArguments($class, $method, \Mmf\IO\RequestInterface $request) {
